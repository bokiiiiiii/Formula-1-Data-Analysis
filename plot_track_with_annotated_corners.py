...
def plot_track_with_annotated_corners(Year: int, EventName: str, SessionName: str, race):
    race.load()
    ...
    plt.plot([scale_pos_x, scale_pos_x + scale_length], [scale_pos_y, scale_pos_y], color='white', lw=1.7)
    plt.plot([scale_pos_x, scale_pos_x], [scale_pos_y, scale_pos_y + 100], color='white', lw=1.7)
    plt.plot([scale_pos_x + scale_length, scale_pos_x + scale_length], [scale_pos_y, scale_pos_y + 100], color='white', lw=1.7)
    plt.text(scale_pos_x + scale_length/2, scale_pos_y + 250, scale_text, ha='center', fontsize=10)
